   ...
   // @IBOutlet weak var authenticationButton: UIButton!
    ...
    func loginViewFetchedUserInfo(loginView : FBLoginView!, user: FBGraphUser) {
        ...
        */
        ...
        //Call FB graph API to get friends info including image URL and save into the database.
        FBRequestConnection.startWithGraphPath("me/friends?fields=name,id,picture", completionHandler: {(connection: FBRequestConnection!, result: AnyObject!, error: NSError!) -> Void in
            if (result? != nil) {
                ...
                // anpther Graph API called inside the completion handler for login user's profile image URL.
